...
int main() {
    ...
    const std::vector<Case> cases = {
        ...
        {"time.now", 0, true}, {"time.monotonic", 0, true},
        {"event.poll", 1, true},
        ...
        {"env.get", 2, true}, {"env.list", 0, true},
        {"system.info", 1, true},
        {"signal.send", 2, true}, {"signal.register", 2, true},
        {"random.u64", 0, true},
        {"error.get", 0, true},
        {"debug.log", 1, true},
        {"module.load", 1, true},
    ...
    std::cout << "Windows capability compliance: " << pass << "/" << cases.size() << "\n";
