...
int main() {
    ...
    const std::vector<Case> cases = {
        ...
        {"process.spawn", CapabilityDomain::PROCESS, 2, false},
        ...
        {"thread.spawn", CapabilityDomain::THREAD, 2, false},
        {"thread.join", CapabilityDomain::THREAD, 1, false},
        ...
        {"event.poll", CapabilityDomain::EVENT, 1, false},
        {"env.get", CapabilityDomain::ENV, 1, false},
        {"signal.send", CapabilityDomain::SIGNAL, 2, true},
        {"signal.register", CapabilityDomain::SIGNAL, 2, false},
