...
#include <vector>
namespace ir {
class Type; class IntegerType; class ArrayType; class VectorType;
...
class ConstantVector : public Constant { public: static ConstantVector* get(VectorType* ty, const std::vector<Constant*>& elements); const std::vector<Constant*>& getElements() const { return elements; } Constant* getElement(size_t index) const { return elements.at(index); } ConstantVector(VectorType* ty, const std::vector<Constant*>& elements); public: std::vector<Constant*> elements; };
